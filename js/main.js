...
var createElements = function createElements(container, products) {
  ...
  products.forEach((function (product, index) {
    ...
    var template = "<article class=\"catalog__item ".concat(index % 2 !== 0 ? "catalog__item--reverse catalog__item--reverse-color" : "", "\">\n\t\t\t<div class=\"container\">\n\t\t\t\t<div class=\"catalog__item-pictures\">\n          <div class=\"catalog__item-picture\">\n            <picture>\n              <source media=\"(min-width: 960px)\" srcset=\"img/").concat(translit(product.model.replace(/\s/g, '-').toLowerCase()), "-").concat(translit(product.type.replace(/\s/g, '').toLowerCase()), "-1-1024.jpg\">\n              <source media=\"(min-width: 720px)\" srcset=\"img/").concat(translit(product.model.replace(/\s/g, '-').toLowerCase()), "-").concat(translit(product.type.replace(/\s/g, '').toLowerCase()), "-1-800.jpg\">\n              <img class=\"catalog__item-img\" width=\"288px\" height=\"288px\" alt=\"").concat(product.model, " ").concat(product.type, " 1\" src=\"img/").concat(translit(product.model.replace(/\s/g, '-').toLowerCase()), "-").concat(translit(product.type.replace(/\s/g, '').toLowerCase()), "-1-600.jpg\">\n            </picture>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"catalog__item-picture\">\n            <picture>\n              <source media=\"(min-width: 960px)\" srcset=\"img/").concat(translit(product.model.replace(/\s/g, '-').toLowerCase()), "-").concat(translit(product.type.replace(/\s/g, '').toLowerCase()), "-2-1024.jpg\">\n              <source media=\"(min-width: 720px)\" srcset=\"img/").concat(translit(product.model.replace(/\s/g, '-').toLowerCase()), "-").concat(translit(product.type.replace(/\s/g, '').toLowerCase()), "-2-800.jpg\">\n              <img class=\"catalog__item-img\" width=\"288px\" height=\"288px\" alt=\"").concat(product.model, " ").concat(product.type, " 2\" src=\"img/").concat(translit(product.model.replace(/\s/g, '-').toLowerCase()), "-").concat(translit(product.type.replace(/\s/g, '').toLowerCase()), "-2-600.jpg\">\n            </picture>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"catalog__item-picture\">\n            <picture>\n              <source media=\"(min-width: 960px)\" srcset=\"img/").concat(translit(product.model.replace(/\s/g, '-').toLowerCase()), "-").concat(translit(product.type.replace(/\s/g, '').toLowerCase()), "-3-1024.jpg\">\n              <source media=\"(min-width: 720px)\" srcset=\"img/").concat(translit(product.model.replace(/\s/g, '-').toLowerCase()), "-").concat(translit(product.type.replace(/\s/g, '').toLowerCase()), "-3-800.jpg\">\n              <img class=\"catalog__item-img\" width=\"288px\" height=\"288px\" alt=\"").concat(product.model, " ").concat(product.type, " 2\" src=\"img/").concat(translit(product.model.replace(/\s/g, '-').toLowerCase()), "-").concat(translit(product.type.replace(/\s/g, '').toLowerCase()), "-3-600.jpg\">\n            </picture>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"catalog__item-description\">\n\t\t\t\t\t<table class=\"catalog__table\">\n\t\t\t\t\t\t<tr class=\"catalog__table-line\">\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell catalog__table-cell--font\">\u041C\u043E\u0434\u0435\u043B\u044C</td>\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell\">").concat(product.model, "</td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t<tr class=\"catalog__table-line\">\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell catalog__table-cell--font\">\u0422\u0438\u043F</td>\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell\">").concat(product.type, "</td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t<tr class=\"catalog__table-line\">\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell catalog__table-cell--font\">\u0420\u0430\u0437\u043C\u0435\u0440</td>\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell\">").concat(product.sizeSmall !== "" ? "".concat(product.sizeSmall, " / ").concat(product.sizeHigh) : "".concat(product.sizeHigh), "</td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t<tr class=\"catalog__table-line\">\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell catalog__table-cell--font\">\u0421\u043E\u0441\u0442\u0430\u0432</td>\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell\">").concat(product.composition, "</td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t<tr class=\"catalog__table-line\">\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell catalog__table-cell--font\">\u0426\u0432\u0435\u0442</td>\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell\">").concat(product.color, "</td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t<tr class=\"catalog__table-line\">\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell catalog__table-cell--font\">\u0420\u043E\u0437\u043D\u0438\u0447\u043D\u0430\u044F \u0446\u0435\u043D\u0430</td>\n\t\t\t\t\t\t\t<td class=\"catalog__table-cell\">\n\t\t\t\t\t\t\t\t<table>\n                  <tr class=\"catalog__table-line catalog__table-line--price\">\n                    ").concat(product.sizeSmall !== "" ? "<td class=\"catalog__table-cell catalog__table-cell--padding\">".concat(product.sizeSmall, "</td>") : "", "\n\t\t\t\t\t\t\t\t\t\t<td class=\"catalog__table-cell catalog__table-cell--padding\">").concat(product.sizeHigh, "</td>\n\t\t\t\t\t\t\t\t\t</tr>\n                  <tr class=\"catalog__table-line catalog__table-line--price\">\n                    ").concat(product.sizeSmall !== "" ? "<td class=\"catalog__table-cell\">".concat(product.priceSmall, "\u0420</td>") : "", "\t\t\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t<td class=\"catalog__table-cell\">").concat(product.priceHigh, "\u0420</td>\n\t\t\t\t\t\t\t\t\t</tr>\n\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t</td>\n\t\t\t\t\t\t</tr>\n\t\t\t\t\t</table>\n\t\t\t\t</div>\n\t\t\t</div>\n    </article>");
